...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full h-[70vh] overflow-hidden">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-5 top-1/2 -translate-y-1/2 bg-white px-3 py-2 rounded-full text-xl font-bold"
      >
        ‹
      </button>
      ...
      <button
        onClick={nextSlide}
        className="absolute right-5 top-1/2 -translate-y-1/2 bg-white px-3 py-2 rounded-full text-xl font-bold"
      >
        ›
      </button>
    </section>
