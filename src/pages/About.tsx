    ...
    <div className="font-sans bg-gray-50 text-gray-900">
      ...
      >
        ...
        <div className="relative z-10 space-y-4 px-6 mt-20">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold drop-shadow-lg animate__animated animate__fadeInDown">
            About <span className="text-yellow-400">Sunflower Public School</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto font-light animate__animated animate__fadeInUp">
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800">Our History</h2>
          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800">Our Vision</h2>
          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800">Meet Our Team</h2>
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="mt-4 text-gray-600">Mr. Omnarayan Rajput's innovative teaching methods and hands-on science experiments inspire students to explore the world around them and become future scientists and innovators.</p>
            </div>
          </div>
        </div>
      </section>
